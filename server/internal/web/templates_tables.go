...
<div class="scrollbody"><div class="fade">
  ...
  <div class="panel" style="overflow:hidden;">
    <div class="thead" style="grid-template-columns:2fr 1fr 1fr 1fr .8fr .8fr .8fr;"><span>SERVICE</span><span style="text-align:right;">TRAFFIC</span><span style="text-align:right;">ERROR %</span><span style="text-align:right;">4XX %</span><span style="text-align:right;">p50</span><span style="text-align:right;">p95</span><span style="text-align:right;">p99</span></div>
    {{range .Services}}
    <a class="trow" style="grid-template-columns:2fr 1fr 1fr 1fr .8fr .8fr .8fr;" href="{{.DrillHref}}">
      ...
      <div class="tnum-s c-txt3" title="4xx client errors (excluded from ERROR %)">{{pctd .Client4xxRate}}</div>
...
<div class="scrollbody"><div class="fade">
  ...
  <div class="panel" style="overflow:hidden;">
    <div class="thead" style="grid-template-columns:2.2fr 1fr 1fr 1fr .7fr .7fr .7fr .8fr .8fr;">
      <span>ENDPOINT</span>
      ...
      <span style="text-align:right;">4XX %</span>
    ...
    {{$win := .Shell.WindowKey}}
    {{range .Endpoints}}
    <a class="trow" style="grid-template-columns:2.2fr 1fr 1fr 1fr .7fr .7fr .7fr .8fr .8fr;" href="/services/{{$svc}}/endpoint?method={{.Method}}&route={{.Route}}&win={{$win}}">
