...
MODULES := proto client client/gin client/nethttp client/echo client/chi server
...
RELEASE_MODULES := proto client server client/gin client/nethttp client/echo client/chi
