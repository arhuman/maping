...
// cumulative GC-pause and CPU counters so each window reports a DELTA rather than
// an ever-growing total. It is touched only from the uploader goroutine (via
